package com.myweimai.doctor.common.util.http;

import com.myweimai.doctor.common.HttpResult;
...
public class HttpHelper {
    ...
    private final RequestConfig defaultRequestConfig = RequestConfig.custom().setSocketTimeout(30000).setConnectTimeout(30000)
    ...
    public HttpResult put(String uri, Map<String, Object> parameters, byte[] body) {
        return put(uri, null, parameters, body);
    }

    public HttpResult put(String uri, Map<String, String> headers, Map<String, Object> parameters, byte[] body) {
        if (uri == null || uri.isEmpty()) {
            throw new IllegalArgumentException("uri is required");
        }
    ...
    public HttpResult delete(String uri, Map<String, String> headers, Map<String, Object> parameters) {
        if (uri == null || uri.isEmpty()) {
            throw new IllegalArgumentException("uri is required");
        }
